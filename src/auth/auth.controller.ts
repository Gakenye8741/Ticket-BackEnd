  ...
  try {
    ...
    const html = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; background-color: #f9f9f9; padding: 20px; border-radius: 8px;">
        ...
        <p>Thank you for registering with our <strong>Madollar Tickets</strong>.</p>
        ...
        <p style="margin-top: 30px;">Thank you,<br><strong>The Madollor Tickets ICT Team</strong></p>
      </div>
    `;
